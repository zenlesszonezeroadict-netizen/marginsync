 ...
 * Mandatory GDPR webhook — a merchant's customer has requested a copy of
...
export async function POST(request: NextRequest) {
  ...
  // Compliance obligation satisfied: no data to return.
  console.log('[GDPR] customers/data_request verified. No customer PII retained by MarginSync.')
